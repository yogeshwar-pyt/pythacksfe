import Clock from '@atom-web/icons-16/Clock';
import Hotel from '@atom-web/icons-16/Hotel';
...
import { ActivityEntity, CostData } from '@apis/fetchCostDataByTrailId';
import ArrowOutwart from '@components/Icons/ArrowOutwart';
        ...
        <Column
          ...
          <Column css={{ gap: '$4i' }}>
            <Row css={{ alignItems: 'center', gap: '$4i' }}>
              <Clock css={{ width: 20, height: 20, fill: '$grey500' }} />
              ...
              <Text
                ...
                {`Pickup time: ${data.time2 ? data.time2 : '--'} `}
              </Text>
            </Row>
            <Row css={{ alignItems: 'center', gap: '$4i' }}>
              <Clock css={{ width: 20, height: 20, fill: '$grey500' }} />
              <Text
                ...
                {`Start time: ${data.time1 ? data.time1 : '--'}`}
              </Text>
            </Row>
            <Row css={{ alignItems: 'center', gap: '$4i' }}>
            ...
            <Row css={{ alignItems: 'center', gap: '$4i' }}>
              <ArrowOutwart css={{ width: 20, height: 20, fill: '$grey500' }} />
              <Text
                css={{
                  fontSize: '$13',
                  lineHeight: '$10i',
            ...
            <Row css={{ alignItems: 'center', gap: '$4i' }}>
              <Hotel css={{ width: 20, height: 20, fill: '$grey500' }} />
              <Text
                css={{
                  fontSize: '$13',
                  lineHeight: '$10i',
