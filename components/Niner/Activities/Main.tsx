...
import { CostData, ActivityEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((activity, index) => {
            ...
            const ninerData = ninerByTrailCostId[activity.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this activity
                        </Text>
                      </Row>
                    ) : (
                      <Checks
