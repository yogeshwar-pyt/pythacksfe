...
import { CostData, FerryEntity } from '@apis/fetchCostDataByTrailId';
  ...
  return (
    <Column css={{ gap: '$6i' }}>
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((ferry, index) => {
            const isExpanded = expandedCardIndex === index;
            const ninerData = ninerByTrailCostId[ferry.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this ferry
                        </Text>
                      </Row>
                    ) : (
                      <Checks
