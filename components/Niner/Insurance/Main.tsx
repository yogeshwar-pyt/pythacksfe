...
import { CostData, InsuranceEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((insurance, index) => {
            ...
            const ninerData = ninerByTrailCostId[insurance.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this insurance
                        </Text>
                      </Row>
                    ) : (
                      <Checks
