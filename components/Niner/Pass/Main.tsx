...
import { CostData, PassEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((pass, index) => {
            ...
            const ninerData = ninerByTrailCostId[pass.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this pass
                        </Text>
                      </Row>
                    ) : (
                      <Checks
