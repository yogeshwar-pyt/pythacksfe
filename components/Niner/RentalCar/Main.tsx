...
import { CostData, RentalCarEntity } from '@apis/fetchCostDataByTrailId';
  ...
  return (
    <Column css={{ gap: '$6i' }}>
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((rentalCar, index) => {
            const isExpanded = expandedCardIndex === index;
            const ninerData = ninerByTrailCostId[rentalCar.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this rentalcar
                        </Text>
                      </Row>
                    ) : (
                      <Checks
