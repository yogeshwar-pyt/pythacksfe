...
import { CostData, CustomEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((custom, index) => {
            ...
            const ninerData = ninerByTrailCostId[custom.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this custom card
                        </Text>
                      </Row>
                    ) : (
                      <Checks
