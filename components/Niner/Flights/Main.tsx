      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((flight, index) => {
            ...
            const ninerData = ninerByTrailCostId[flight.trail_cost_id] || [];
                ...
                <Row
                  ...
                  <Column
                    ...
                    {flight &&
                      ...
                      flight?.flight_details?.map((item, index) => {
                        const isFirstInclusion = index === 0;
                        return (
                          <Fragment key={index}>
                            {(isFirstInclusion || isExpanded) && (
                              <Inclusions
                                index={index}
                                key={index}
                                inclusion={item}
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this flight
                        </Text>
                      </Row>
                    ) : (
                      <Checks
