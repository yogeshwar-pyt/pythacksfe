...
import { CostData, TransferEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((transfer, index) => {
            ...
            const ninerData = ninerByTrailCostId[transfer.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this transfer
                        </Text>
                      </Row>
                    ) : (
                      <Checks
