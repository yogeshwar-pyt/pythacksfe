...
import { CostData, TrainEntity } from '@apis/fetchCostDataByTrailId';
      ...
      <Column css={{ gap: '$8i', height: 'auto' }}>
        {data &&
          data.map((train, index) => {
            ...
            const ninerData = ninerByTrailCostId[train.trail_cost_id] || [];
                    ...
                    {totalChecks === 0 ? (
                      <Row
                        ...
                        <Text
                          ...
                          No Niner checks are available for this train
                        </Text>
                      </Row>
                    ) : (
                      <Checks
